...
function Trig_ArUP_ACT takes nothing returns nothing
...
call SaveInteger(hs,GetHandleId(Hero[i]),StringHash("tomioka ArUP"),1)
endif
...
call BlzSetAbilityIcon(LaxusG_ID, "ReplaceableTextures\\CommandButtons\\BTNHero_Laxus_G1.blp")
call SaveInteger(hs,GetHandleId(c),StringHash("lvl5"),0)
endif
endif
...
//===========================================================================
function InitTrig_ARUP takes nothing returns nothing
local integer i = 0
local trigger trg2 = CreateTrigger()
    loop
    exitwhen i== 12
    call TriggerRegisterPlayerEvent(trg2, Player(i), EVENT_PLAYER_ARROW_UP_DOWN)
    set i = i + 1
    endloop
    call TriggerAddAction( trg2, function Trig_ArUP_ACT )
    set trg2 = null
endfunction
