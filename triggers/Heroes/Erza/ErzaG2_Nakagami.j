            ...
            loop
                ...
                if SpellBoolCaster(c) and r <= rmax then
                    ...
                    if r == rmax then
                        ...
                        call DestroyEffect(EffectSpawn("war3mapimported\\wos_BY_Wood_Eff_Ord_DanGe_Wav_Kuosan_1_3_0.5s.mdx", x, y, 1, 1, 1.22, 100))
                        set k = 0
                        loop
                            exitwhen k > 3
            ...
            loop
                ...
                if SpellBoolCaster(c) and SpellBoolCaster(td) and r <= rmax then
                    ...
                    if r == rmax then
                        ...
                        call DestroyEffect(EffectSpawn("war3mapimported\\wos_BY_Wood_Eff_Ord_DanGe_Wav_Kuosan_1_3_0.5s.mdx", x, y, 1, 1, 0.9, 100))
                        set k = 0
                        loop
                            exitwhen k > 3
                    ...
                    call BlzSetUnitFacingEx(c,a*bj_RADTODEG)
                        ...
                        if r == rmax then
                            ...
                            loop
                                exitwhen k > 4
                                if k <= 4 then
                                    call DestroyEffect(EffectSpawn3("war3mapimported\\wos_BY_Wood_Eff_Ord_DanGe_Wav_Kuosan_1_3_0.5s.mdx", x, y, GetRandomReal(0, 359), 1, 1.4, 150, -30))
                                endif
                                set r5 = GetRandomReal(100, 350)
