            ...
            loop
                ...
                if SpellBoolCaster(c) and SpellBoolCaster(td) and r <= rmax then
                    ...
                    call EffectSpawn2("war3mapimported\\wos_krk (1849)5.mdx",x,y,k*60,1.25,2,100,0.8)
                            call ColorEffDummy3(EffectSpawn3("war3mapimported\\wos_BY_Wood_Eff_Ord_DanGe_Wav_Kuosan_1_3_0.5s.mdx",x,y,GetRandomReal(0,359),1,1.5,150,-30),0,255,255,255,0.35)                            
