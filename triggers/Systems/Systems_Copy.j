...
if id == Natsu_ID or id == Patriot_ID then
    ...
    set ItemsPage0_ID[i2+9] = 'I01M' // kansho and bakuya
    ...
    set ItemsPage0_ID[i2+28] = 'I01M' // kansho and bakuya    
...
if id == Laxus_ID  then
   ...
   // //set ItemsPage0_ID[i2+1] = 'I00S' // funny present
    ...
    set ItemsPage0_ID[i2+28] = 'I00R' // kazekage hat    
    set ItemsPage0_ID[i2+29] = 'I00O' // urahara set
    set ItemsPage0_ID[i2+30] = 'I00M' // cup of tea
    set ItemsPage0_ID[i2+31] = 'I00B' // Oken
    set ItemsPage0_ID[i2+32] = 'I01Q' // ryujin jakka
...
if id == Neuvillette_ID then
  ...
  //  //set ItemsPage0_ID[i2+1] = 'I00S' // funny present
    ...
    set ItemsPage0_ID[i2+31] = 'I01L' // kazekage hat
...
if id == Barragan_ID then
  ...
  //  //set ItemsPage0_ID[i2+1] = 'I00S' // funny present
    ...
    set ItemsPage0_ID[i2+28] = 'I00Y' // angel blessing
    set ItemsPage0_ID[i2+29] = 'I00B' // Oken
    set ItemsPage0_ID[i2+30] = 'I01Q' // ryujin jakka
    set ItemsPage0_ID[i2+31] = 'I01L' // kazekage hat
    set ItemsPage0_ID[i2+32] = 'I011' // okarun egg
...
if id == Kyoraku_ID then
  ...
  //  //set ItemsPage0_ID[i2+1] = 'I00S' // funny present
    ...
    set ItemsPage0_ID[i2+29] = 'I00B' // Oken
    set ItemsPage0_ID[i2+30] = 'I01M' // kansho and bakuya
...
if id == Inori_ID then
    ...
    set ItemsPage0_ID[i2+32] = 'I011' // okarun egg
    set ItemsPage0_ID[i2+33] = 'I01L' // kazekage hat
endif 
if id == AlterSaber_ID then
    set ItemsPage0_ID[i2+0] = 'I007' // sonic boots
    //set ItemsPage0_ID[i2+1] = 'I00S' // funny present
    ...
    set ItemsPage0_ID[i2+8] = 'I01M' // kansho and bakuya
...
if id == Gojo_ID or id == Ainz_ID then
    ...
    set ItemsPage0_ID[i2+28] = 'I00B' // Oken
    set ItemsPage0_ID[i2+29] = 'I01L' // kazekage hat
    set ItemsPage0_ID[i2+30] = 'I01B' // cup of tea
...
function SetHpCurrent2 takes unit c,unit td, real r returns nothing
    ...
    if GetUnitAbilityLevel(c,'B02F')> 0 then 
    set r =r * 0.51
    elseif GetUnitAbilityLevel(c,'B02E')> 0 then 
    set r =r * 0.58
    elseif GetUnitAbilityLevel(c,'B01W')> 0 then 
    set r =r * 0.65
    elseif GetUnitAbilityLevel(c,'B01V')> 0 then
    set r =r * 0.72
    elseif GetUnitAbilityLevel(c,'B01U')> 0 then
    set r =r * 0.79
    elseif GetUnitAbilityLevel(c,'B01T')> 0 then
    set r =r * 0.86
    elseif GetUnitAbilityLevel(c,'B01S')> 0 then
    set r =r * 0.93
    endif
...
// Дебафф Ainz T уменьшает итоговое физическое сопротивление цели на 30%.
    ...
    if isMagic then
        ...
        if targetId == Asta_ID and GetHeroLevel(td) >= 6 then
            ...
            if GetUnitAbilityLevel(td, 'B02Q') > 0 then
            set dmg = dmg * 0.85
            endif
        // Harribel E
